...
//        hideProgressDialog()
        ...
        if(product.stock_quantity.toInt()==0){
            ...
            binding?.tvProductDetailsStockQuantity?.typeface = Typeface.createFromAsset(assets,"Montserrat-Bold.ttf")
        ...
        if(p0 != null){
            when(p0?.id){
                ...
                binding?.btnGoToCart?.id -> {
                    val intent: Intent = Intent(this@ProductDetailActivity,CartProductListActivity::class.java)
